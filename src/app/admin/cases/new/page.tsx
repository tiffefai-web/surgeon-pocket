...
function NewCaseForm() {
  ...
  const defaultLocation = searchParams?.get('location') || 'Phitsanulok Hospital';

  const [state, formAction, isPending] = useActionState(createCaseAction, { error: '' });
  ...
  const [surgeryDuration, setSurgeryDuration] = useState('60');
    ...
    <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-xl border border-blue-50 overflow-hidden mt-4">
      <div className="bg-blue-600 px-6 py-4 border-b border-blue-700 flex items-center justify-between">
        <div className="flex items-center text-white">
          <a href="/admin" className="mr-4 hover:text-blue-200 transition">
          ...
          <h2 className="text-xl font-bold">Add New Surgical Case</h2>
        </div>
        <a href="/admin" className="text-blue-100 hover:text-white text-sm font-medium">Cancel</a>
      </div>
      ...
      <form action={formAction} className="p-6 space-y-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            <div className="md:col-span-1">
              ...
              <input name="patientHn" type="text" required className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="e.g. 1234567" />
            </div>
            <div className="md:col-span-1">
              <label className="block text-sm font-medium text-gray-700 mb-1">First Name *</label>
              <input name="firstName" type="text" required className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" />
            </div>
            <div className="md:col-span-1">
              <label className="block text-sm font-medium text-gray-700 mb-1">Last Name *</label>
              <input name="lastName" type="text" required className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" />
            </div>
            <div className="md:col-span-1">
              <label className="block text-sm font-medium text-gray-700 mb-1">Contact Phone</label>
              <input name="contactPhone" type="tel" pattern="[0-9\s\-+]+" className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="e.g. 081-234-5678" />
            </div>
            <div className="md:col-span-1">
              <label className="block text-sm font-medium text-gray-700 mb-1">Gender</label>
              <select name="gender" className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border bg-white">
            ...
            <div className="md:col-span-1">
              ...
              <input name="age" type="number" className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" />
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input name="underlyingDiseases" type="text" className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="e.g. HT, DM type 2" />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Past Surgical History</label>
                <input name="pastSurgicalHistory" type="text" className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="e.g. Appendectomy 2015" />
              </div>
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input name="diagnosis" type="text" required className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="e.g. Acute Appendicitis" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Operation *</label>
              <input name="operation" type="text" required className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="e.g. Laparoscopic Appendectomy" />
            </div>
          </div>
            ...
            {patientType === 'IPD' && (
              <div className="md:col-span-1 animate-fade-in-up">
                ...
                <div className="flex items-center">
                  ...
                  <input type="number" name="admitDaysPrior" defaultValue={1} min={1} className="w-16 text-center border-gray-300 rounded shadow-sm focus:border-blue-500 py-1.5 px-2 border" />
        ...
        <section>
          ...
          <div className="flex gap-8 mb-6">
            <label className="flex items-center cursor-pointer">
              ...
              <input type="checkbox" name="consultAnes" value="true" className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500" />
            </label>
            <label className="flex items-center cursor-pointer">
              <span className="text-sm font-medium text-gray-700 mr-3">Med Result Ready</span>
              <input type="checkbox" name="medResult" value="true" className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500" />
            </label>
          </div>
          ...
          <div>
            ...
            <textarea name="extraNotes" rows={3} className="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border" placeholder="Any additional information..."></textarea>
          </div>
        </section>
        ...
        <div className="pt-4 border-t border-gray-200 flex justify-end gap-4">
          <a href="/admin" className="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium">
            Cancel
          </a>
          <button type="submit" disabled={isSubmitDisabled} className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center shadow-lg">
            {isPending ? 'Saving Case...' : 'Save Case'}
          </button>
        </div>
